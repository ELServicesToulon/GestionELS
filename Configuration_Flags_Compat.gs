...
const __FLAGS = Object.freeze({
  THEME_V2_ENABLED: typeof THEME_V2_ENABLED !== 'undefined' ? THEME_V2_ENABLED : false,
  THEME_SELECTION_ENABLED: typeof THEME_SELECTION_ENABLED !== 'undefined' ? THEME_SELECTION_ENABLED : false,
    ...
    RESERVATION_CACHE_ENABLED: typeof RESERVATION_CACHE_ENABLED !== 'undefined' ? RESERVATION_CACHE_ENABLED : false,
    RESERVATION_SHOW_TAKEN_SLOTS_ENABLED: typeof RESERVATION_SHOW_TAKEN_SLOTS_ENABLED !== 'undefined' ? RESERVATION_SHOW_TAKEN_SLOTS_ENABLED : false,
    DEBUG_MENU_ENABLED: typeof DEBUG_MENU_ENABLED !== 'undefined' ? DEBUG_MENU_ENABLED : false,
  PRICING_RULES_V2_ENABLED: typeof PRICING_RULES_V2_ENABLED !== 'undefined' ? PRICING_RULES_V2_ENABLED : false,
  CALENDAR_RESYNC_ENABLED: typeof CALENDAR_RESYNC_ENABLED !== 'undefined' ? CALENDAR_RESYNC_ENABLED : false,
  CALENDAR_PURGE_ENABLED: typeof CALENDAR_PURGE_ENABLED !== 'undefined' ? CALENDAR_PURGE_ENABLED : false,
  ADMIN_OPTIMISTIC_CREATION_ENABLED: typeof ADMIN_OPTIMISTIC_CREATION_ENABLED !== 'undefined' ? ADMIN_OPTIMISTIC_CREATION_ENABLED : false,
