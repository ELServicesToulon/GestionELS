var UtilsSharedFallback = (function() {
// =================================================================
...
function assertReservationId(id) {
  ...
  return {
    formaterDateEnYYYYMMDD: formaterDateEnYYYYMMDD,
    formaterDateEnHHMM: formaterDateEnHHMM,
    formaterDatePersonnalise: formaterDatePersonnalise,
    formatMoisFrancais: formatMoisFrancais,
    formatMontantEuro: formatMontantEuro,
    normaliserCodePostal: normaliserCodePostal,
    insererImageDepuisPlaceholder: insererImageDepuisPlaceholder,
    getLogoSvgBlob: getLogoSvgBlob,
    loadInlineSvgFromFile: loadInlineSvgFromFile,
    getLogoBlob: getLogoBlob,
    getLogoDataUrl: getLogoDataUrl,
    blobToDataUrl: blobToDataUrl,
    getBundledLogoDataUrl: getBundledLogoDataUrl,
    getLogoPublicUrl: getLogoPublicUrl,
    getLogoEmailBlockHtml: getLogoEmailBlockHtml,
    encodeMailSubjectUtf8: encodeMailSubjectUtf8,
    toCents: toCents,
    fromCents: fromCents,
    nextInvoiceNumber: nextInvoiceNumber,
    obtenirIndicesEnTetes: obtenirIndicesEnTetes,
    obtenirOuCreerDossier: obtenirOuCreerDossier,
    trouverTableBordereau: trouverTableBordereau,
    test_logHeadersModeleFacture: test_logHeadersModeleFacture,
    logFailedLogin: logFailedLogin,
    logRequest: logRequest,
    include: include,
    getSecret: getSecret,
    normalizeSecretValue_: normalizeSecretValue_,
    extractIdFromUrl_: extractIdFromUrl_,
    normalizeCalendarId_: normalizeCalendarId_,
    setSecret: setSecret,
    verifySignedLink: verifySignedLink,
    generateSignedClientLink: generateSignedClientLink,
    getConfiguration: getConfiguration,
    assertClient: assertClient,
    assertReservationId: assertReservationId
  };
})();
